...
const GROWING_FIELDS = ['achievements', 'upgrades', 'layout', 'fameShopUpgrades', 'buildings', 'bgmUnlocked', 'seasonalComplaintsResolved', 'daily', 'townExpansions', 'happinessExpansions', 'hiddenBuildingIds', 'questsClaimed', 'dimensionShopUpgrades', 'relicShopUpgrades', 'townThemesOwned'];
